package com.javashitang.rocketmq.config;

import com.javashitang.rocketmq.consumer.LogReceiverListener;
...
public class RabbitMqConfig {
    ...
    public ConnectionFactory msgConnectionFactory(
            ...
            @Value("${spring.rocketmq.port}") int port,
            @Value("${spring.rocketmq.username}") String username,
            @Value("${spring.rocketmq.password}") String password,
            @Value("${spring.rocketmq.virtual-host}") String vhost) {
